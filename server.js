...
app.get("/on", function(req, res) {
    ...
    deviceRegistry_pool.query('SELECT item_id, table_name FROM device_list', function(err, results, fields){
        ...
        sensor_model_pool.query('INSERT INTO '+results[device_id]+'_act (actuator, status) VALUES(?, 1)', actuator);
...
app.get("/off", function(req, res) {
    ...
    deviceRegistry_pool.query('SELECT item_id, table_name FROM device_list', function(err, results, fields){
        ...
        console.log('inside dict - res : ', results[device_id])
        sensor_model_pool.query('INSERT INTO '+results[device_id]+'_act (actuator, status) VALUES(?, 0)', actuator);
        res.send(200)
    })
})
